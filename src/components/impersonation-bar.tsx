...
export function ImpersonationBar() {
  ...
  return (
    <div className="impersonation-bar bg-orange-600 text-white py-2 px-4 flex items-center justify-between shadow-lg sticky top-0 z-[60] animate-in slide-in-from-top duration-300">
