...
import { BarChart3, Coins, FileText, ImageIcon, Music, Sparkles, Zap, MicVocal, UserPlus, Users } from 'lucide-react';
...
export function DailySummary() {
    ...
    const totalVoiceGenerations = (summary.fastVoicesGenerated || 0) + (summary.voiceCloningGenerations || 0) + (summary.hqVoicesSubmitted || 0);
    const onlineUsersToday = summary.onlineUsers && typeof summary.onlineUsers === 'object' ? Object.keys(summary.onlineUsers).length : 0;
        ...
        <Card className="rounded-[2rem] border-none shadow-xl bg-card overflow-hidden">
            ...
            <CardContent className="p-3">
                <div className="grid grid-cols-2 gap-2">
                    ...
                    <SummaryRow icon={<Users className="h-3.5 w-3.5" />} label="Online Today" value={onlineUsersToday.toLocaleString()} isLoading={isLoading} colorClass="text-emerald-600" />
