...
const SIDEBAR_STORAGE_KEY = "12labs_sidebar_state"
...
>(
  (
    ...
    if (!mounted) {
      return <div ref={ref} className="group peer hidden md:block" />
    }
        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            <SheetHeader className="border-b p-4">
                <SheetTitle>Production Node Menu</SheetTitle>
            </SheetHeader>
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed bottom-0 top-16 z-10 hidden w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
            side === "left"
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex flex-1 flex-col overflow-y-auto bg-background",
