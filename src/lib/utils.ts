 ...
 *
 * Balances drift into fractions as tools charge partial credits, so a raw
 * `toLocaleString()` produces things like "100,197.4" — a decimal point in
 * a wallet figure reads as a price, not a balance. This always shows a
 * whole, fully written-out number.
 *
