...
8. GRAMMATICAL GENDER (CRITICAL — check this on EVERY line): Hindi and other gender-marking languages (Urdu, Marathi, Gujarati, Punjabi) inflect the verb for the speaker's gender. A male speaker says मैं करूंगा / मैं गया / मैं जा रहा था; a female speaker says मैं करूंगी / मैं गई / मैं जा रही थी. Decide each character's gender ONCE before writing their first line and keep every verb ending consistent with it for the whole script — never let a character switch endings partway through. When a character talks ABOUT someone else, the agreement follows that person's gender (वह चली गई for a woman, not वह चला गया). This applies to the narrator too. If {language} does not mark gender on verbs (English, Tamil, Telugu, Kannada, Malayalam), ignore this rule entirely rather than inventing forms that don't exist.
